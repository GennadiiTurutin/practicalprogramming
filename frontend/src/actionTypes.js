...
export const FETCH_CABINET_START = 'FETCH_USER_START'
export const FETCH_CABINET_SUCCESS = 'FETCH_USER_SUCCESS'
export const FETCH_CABINET_FAILURE = 'FETCH_USER_FAILURE'
